...
frappe.views.BaseList = class BaseList {
	...
	setup_defaults() {
		...
		this.page_title = this.page_title || frappe.router.doctype_layout || __(this.doctype, null, frappe.trans_context("Doctype", this.doctype));
		this.meta = frappe.get_meta(this.doctype);
		this.autoname_field = this.meta.autoname && this.meta.autoname.includes("field")? this.meta.autoname.split(":")[1]: null;
